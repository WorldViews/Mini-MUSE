...
VIDEOS = {}
VIDEOS['heart'] = 'https://www.youtube.com/embed/KbCZfE0Wqgs?autoplay=1';
VIDEOS['purse'] = 'https://www.youtube.com/embed/b6V8qubr664?autoplay=1';
VIDEOS['crane'] = 'https://www.youtube.com/embed/uUkcD9jD5xY?autoplay=1';
VIDEOS['chocolate'] = 'http://192.168.16.89:8005/youtubePlayer.html';
...
class ReachAndTeachScript(ControlScript):
    ...
    def noticeNewObject(self, label):
        ...
        if label not in VIDEOS:
            ...
            return
        msg = {'type': 'setVideoId', 'videoId': VIDEOS[label]}
        print("msg:", msg)
